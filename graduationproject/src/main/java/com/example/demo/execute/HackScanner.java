...
public final class HackScanner implements Iterator<String>, Closeable {
     ...
     * @return this scanner
     */
    public com.example.demo.execute.HackScanner useDelimiter(Pattern pattern) {
        delimPattern = pattern;
        return this;
    }
     ...
     * @return this scanner
     */
    public com.example.demo.execute.HackScanner useDelimiter(String pattern) {
     ...
     * @return this scanner
     */
    public com.example.demo.execute.HackScanner useLocale(Locale locale) {
     ...
     */
    public com.example.demo.execute.HackScanner useRadix(int radix) {
     ...
     * @throws IllegalStateException if this scanner is closed
     */
    public com.example.demo.execute.HackScanner skip(Pattern pattern) {
        ensureOpen();
        if (pattern == null)
            throw new NullPointerException();
        clearCaches();
     ...
     * @throws IllegalStateException if this scanner is closed
     */
    public com.example.demo.execute.HackScanner skip(String pattern) {
     ...
     * @since 1.6
     */
    public com.example.demo.execute.HackScanner reset() {
