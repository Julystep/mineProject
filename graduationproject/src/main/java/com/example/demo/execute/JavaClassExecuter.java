...
public class JavaClassExecuter {
    ...
    public static String execute(byte[] classByte,String systemIn){
        ...
        //替换System和Scanner
        byte[] modiBytes = classModifier.modifyUTF8Constant("java/lang/System", "com/example/demo/execute/HackSystem");
        modiBytes = classModifier.modifyUTF8Constant("java/util/Scanner", "com/example/demo/execute/HackScanner");
